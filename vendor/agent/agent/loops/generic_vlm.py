...
class GenericVlmConfig(AsyncAgentConfig):
    async def predict_step(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ImportError("Pillow not installed. Please install it with `pip install Pillow`.")
    ...
    async def predict_click(
        ...
        try:
            ...
            rh, rw = _smart_resize(h, w, factor=32, min_pixels=min_pixels, max_pixels=max_pixels)
        except ImportError:
            raise ImportError("Pillow not installed. Please install it with `pip install Pillow`.")
